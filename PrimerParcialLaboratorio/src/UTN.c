...
int menu()
{
	...
	printf("3) MODIFICAR\n");
	printf("4) BAJA\n");
	printf("5) LISTADO ORDENADO\n");
	printf("6) LISTAR CENSISTA\n");
	printf("7) INFORMES\n");
	printf("8) SALIR\n");
...
int otroMenuAlta()
{
    ...
    printf("3) Alta Descripcion\n");
    printf("4) SALIR\n");


    utn_getInt("\nIngrese opcion: ", "Ingrese una opcion entre 1 y 6", &opcion, 1, 4, 1);
...
int otroMenuMostrar()
{
    ...
    printf("1) Mostrar dueño\n");
    printf("2) Mostrar mascota\n");
    printf("3) Mostrar mascota con dueño\n");
    printf("4) SALIR\n");
...
int otroMenuBaja()
{
    ...
    utn_getInt("\nIngrese opcion: ", "Ingrese una opcion entre 1 y 6", &opcion, 1, 3, 1);
...
int informes()
{
    ...
    printf("                INFORMES                \n\n");
    printf("1-El o los censistas con más censos realizados.\n");
    printf("2-Salir\n");
    utn_getInt("\nIngrese opcion: ", "", &respuesta, 1, 2, 1);
...
int modificar()
{
    ...
    printf("                Modificar                \n\n");
    printf("1-calle\n");
    printf("2-cantidad de personas\n");
    printf("3-canitdad de habitaciones\n");
    printf("4-tipo de vivienda\n");
    printf("5-Salir\n");
    utn_getInt("\nIngrese opcion: ", "", &respuesta, 3, 5, 1);
...
int modificarMascota()
{
    ...
    printf("                Modificar                \n\n");
    printf("1-Nombre de Mascota\n");
    printf("2-Raza\n");
    printf("3-Sexo de Mascota\n");
    printf("4-Salir\n");
    utn_getInt("\nIngrese opcion: ", "", &respuesta, 3, 4, 1);
